 ...
 * This is so that we can pass around Typed {} types.
 *
 ...
 */
public abstract class TypeReference<T extends com.zipper.wallet.ether.abi.datatypes.Type>
    ...
    public static <T extends com.zipper.wallet.ether.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
    ...
    public abstract static class StaticArrayTypeReference<T extends com.zipper.wallet.ether.abi.datatypes.Type>
